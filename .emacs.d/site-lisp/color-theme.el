...
Green on black theme including font-lock, speedbar, and widget."
  ...
  (color-theme-install
   '(color-theme-euphoria
     ...
     (default ((t (:stipple nil :background "#232323" :foreground "#00ff00" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :width normal :family "misc-fixed"))))
     ...
     (mouse ((t (:background "paleturquoise4"))))
     (primary-selection ((t (:background "#00ff00" :foreground "black"))))
     (region ((t (:background "paleturquoise4" :foreground "white"))))
